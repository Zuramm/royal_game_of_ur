...
func _ready():
	...
	$Highlight.material_override = preload("res://entity/board_move_material.tres")
	$Highlight.update_mesh()
	
	$MeshInstance3D.visible = false
	if does_kill:
		$MeshInstance3D.material_override = preload("res://entity/board_move_material_kill.tres")
		$Highlight.material_override = $MeshInstance3D.material_override
	update_path()
